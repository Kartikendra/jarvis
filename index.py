...
if __name__ == "__main__":
    ...
    while True:
        ...
        if "wikipedia" in query:
            ...
            ans_m = " For your information Mohammad Faisal Created me ! I give Lot of Thannks to Him "
            print(ans_m)
            speak(ans_m)
            ...
            hel = "Hello Mohammad Faisal Sir ! How May i Help you.."
            print(hel)
            speak(hel)
            ...
            ex_exit = 'It was nice to meet you Thank you sir ,have i good day'
            speak(ex_exit)
            exit()    
        else:
            temp = query.replace(' ','+')
